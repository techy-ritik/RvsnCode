  ...
  static addProduct(id, productPrice) {
    ...
    fs.readFile(p, (err, fileContent) => {
      ...
      if (existingProduct) {
        ...
        updatedProduct = { id: id, qty: 1 }; //  as initially there will be no product in the cart so it starts with saving product with id and qty details only so there will be always only id, qty and totalprice data will be available in cart file
